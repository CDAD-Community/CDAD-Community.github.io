// Site Configuration
const SITE_CONFIG = {
    domain: 'https://cdad-community.github.io',
    baseUrl: '/',
    ...
    navigation: {
        en: [
            { label: 'Home', href: '/en/' },
            { label: 'About', href: '/en/about.html' },
            { label: 'Problem', href: '/en/problem.html' },
            { label: 'Approach', href: '/en/approach.html' },
            { label: 'Ecosystem', href: '/en/ecosystem.html' },
            { label: 'Methodology', href: '/en/methodology.html' },
            { label: 'CDAD 2.1', href: '/en/cdad-2-1.html' },
            { label: 'Quick User Manual', href: '/en/quick-user-manual.html' },
            { label: 'CDAD v3', href: '/en/cdad-v3.html' },
            { label: 'FAQ', href: '/en/faq.html' }
        ],
        es: [
            { label: 'Inicio', href: '/es/' },
            { label: 'Acerca', href: '/es/acerca.html' },
            { label: 'Problema', href: '/es/problema.html' },
            { label: 'Enfoque', href: '/es/enfoque.html' },
            { label: 'Ecosistema', href: '/es/ecosistema.html' },
            { label: 'Metodología', href: '/es/metodologia.html' },
            { label: 'CDAD 2.1', href: '/es/cdad-2-1.html' },
            { label: 'Manual de Usuario', href: '/es/manual-usuario-rapido.html' },
            { label: 'CDAD v3', href: '/es/cdad-v3.html' },
            { label: 'Preguntas Frecuentes', href: '/es/preguntas-frecuentes.html' }
        ]
    },
